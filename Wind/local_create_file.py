...
def process_wind(path):
    ...
    summary.createDimension('latitude', 361)
    summary.createDimension('longitude', 720)
    ...
    s_speed = summary.createVariable('speed', 'float32', ('latitude', 'longitude', 'direction',), zlib=True, complevel=9, chunksizes=(19, 40, 8), least_significant_digit=2)
    s_freqency = summary.createVariable('frequency', 'float32', ('latitude', 'longitude', 'direction',), zlib=True, complevel=9, chunksizes=(19, 40, 8), least_significant_digit=2)
